...
{
  m4 res;
  res.x.x=a.x.x*b.x.x+a.x.y*b.y.x+a.x.z*b.z.x+a.x.w*b.w.x;
  ...
  res.y.x=a.y.z*b.x.x+a.y.y*b.y.x+a.y.z*b.z.x+a.y.w*b.w.x;
  ...
  res.z.x=a.z.x*b.x.x+a.z.y*b.y.x+a.z.z*b.z.x+a.z.w*b.w.x;
  ...
  res.w.x=a.w.x*b.x.x+a.w.y*b.y.x+a.w.z*b.z.x+a.w.w*b.w.x;
